...
def get_config():
    ...
    wandb.project = "Rev_Paper_example_1rev"
    wandb.name = "case17_ModMLP_fourier_scale1_dim128_wide_nograd"
    wandb.tag = None
    ...
    material_properties.heat_transfer_coefficient = 0.
    ...
    process_conditions.init_length = jnp.array([0.0])
    ...
    dimensions.x_max = 2.5  # bead length
    ...
    training.time_batch_size_per_device = 64
